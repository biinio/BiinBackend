module.exports = function () {
    ...
    var biiniesDevice = require('../schemas/biiniesDevice');
     ...
     * @returns {Promise}
     */
    functions.sendToUser = function (to, title, message, sound, badge, data) {
    ...
    functions.sendToEverybody = function (message, title, sound, badge, data) {
        function callback(error, incomingMessage, body){
            if(error){
                throw  error;
            }else{
