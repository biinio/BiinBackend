...
exports.listShowcase = function (req, res) {
...
exports.getShowcase = function (req, res) {
...
exports.setShowcase = function (req, res) {
...
exports.markAsDeletedShowcase = function (req, res) {
    //Perform a delete
    var organizationIdentifier = req.param('identifier');
    var showcaseIdentifier = req.param("showcase");
    ...
    var updateLinkingReferences = function (callback) {
        ...
        organization.findOne({
            ...
            'sites.showcases.showcaseIdentifier': showcaseIdentifier
...
exports.getByBiinShowcase = function (req, res) {
...
exports.getShowcaseIdShowcase = function (req, res) {
    res.json({data: utils.getGUID()});
}

//POST an image for a showcase
exports.imagePostShowcase = function (req, res, next) {
...
//POST image crop
exports.imageCropShowcase = function (req, res, next) {
    try {
