...
exports.listBiins = function (req, res) {
...
exports.listJsonBiins = function (req, res) {
...
exports.getByOrganizationBiins = function (req, res) {
...
exports.setShowcasesPerBiins = function (req, res) {
    var model = req.body.model;

    var currentSavedBiin = 0;
    var biinsToUpdate = model.biins;

    var updateBiin = function () {
        if (biinsToUpdate.length == currentSavedBiin) {
            res.send({}, 200);
        } else {
            biins.update(
                {
                    'identifier': biinsToUpdate[currentSavedBiin].identifier
                },
                {
                    $set: {
                        'objects': biinsToUpdate[currentSavedBiin].objects
                    }
                }, function (err) {
                    if (err) {
                        res.send({}, 500);
...
exports.updateSiteBiins = function (req, res) {
    var organizationId = req.param('identifier');
...
exports.setObjectsBiins = function (req, res) {
...
//Set the objects of a Biin
exports.updateBiin = function (req, res) {
    var orgID = req.param('identifier');
    var biinIdentifier = req.param('biinIdentifier');
    var biin = req.body;
    if (biin.biinType == "2") {
        biins.find({
                organizationIdentifier: biin.organizationIdentifier,
                venue: biin.venue,
                siteIdentifier: biin.siteIdentifier,
                biinType: "3"
            },
