...
exports.getBiinsOrganizationInformation = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
...
exports.biinPurchase = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    var beacon = req.body;
...
exports.getBeaconChildren = function (req, res) {
    res.setHeader('Content-Type', 'application/json');
