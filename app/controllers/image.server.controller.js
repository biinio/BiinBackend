...
//Upload an image
exports.upload = function (originUrl, imagePath, imageName, callback) {
...
//Crop an Image
exports.cropImage = function (pixelEquival, moduleOwner, imageUrl, resizeW, resizeH, cropW, cropH, positionX, positionY, callback) {
    var that = this;
...
//Uploads an imag
exports.uploadFile = function (imagePath, directory, imageName, callback) {
    this.uploadFileAzure(imagePath, directory, imageName, true, callback);
};

exports.uploadFile = function (imagePath, directory, imageName, generateName, callback) {
    this.uploadFileAzure(imagePath, directory, imageName, generateName, callback);
};

//Uploads an imag
exports.uploadFileAzure = function (imagePath, directory, imageName, generateName, callback) {
...
exports.copyToFtp = function (localPath, ftpPath, systemImageName, callback) {
    var remotePath = ftpPath + systemImageName;
    utils.FTPUpload(localPath, remotePath, callback);
};

exports.copyPackToFTP = function (gallery, callback) {
