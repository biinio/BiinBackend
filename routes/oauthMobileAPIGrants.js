module.exports = function () {
    var functions = {};
    var oauthMobileAPIGrants = require('../schemas/oauthMobileAPIGrants')
    ...
    functions.set = function(req, res) {
        ...
        oauthMobileAPIGrants.findOne({clientIdentifier: clientId}, function (err, user) {
            if(user) {
            	...
            	//Save the client
                var newModel = new oauthMobileAPIGrants({clientIdentifier: clientId, clientSecret: clientSecret,creationData:date});                    
