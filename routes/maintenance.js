module.exports = function () {
	...
	functions.getOrganizationInformation = function(req,res){	
		...
		organization.find({},{_id:0,identifier:1,biinsAssignedCounter:1,name:1,brand:1,description:1,extraInfo:1,media:1,biins:1,biinsCounter:1,majorCounter:1,sites:1,purchasedBiinsHist:1}).lean().exec(function (err, data) {
	...
	functions.getBiinsOrganizationInformation = function(req,res){	
		...
		biins.find({organizationIdentifier:orgId},{_id:0,identifier:1,name:1,major:1,minor:1,proximityUUI:1,status:1,isAssigned:1,organizationIdentifier:1,siteIdentifier:1}).lean().exec(function (err, data) {
			var biins = data;
			res.json(biins);
		});
	}
