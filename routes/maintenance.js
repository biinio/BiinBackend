module.exports = function () {
	...
	functions.getBiinsOrganizationInformation = function(req,res){	
		...
		biins.find({organizationIdentifier:orgId},{_id:0,identifier:1,name:1,major:1,minor:1,proximityUUID:1,status:1,isAssigned:1,brandIdentifier:1,organizationIdentifier:1,siteIdentifier:1}).lean().exec(function (err, data) {
			var response = {};
			response.biins = data;
