module.exports = function () {
	...
	functions.getVenueALike = function(req,res){	
		...
		venues.find({name:regexName,organizationIdentifier:orgIdentifier},{_id:0,identifier:1,name:1}).lean().exec(function (err, data) {
	...
	functions.createVenue = function(req,res){	
		...
		venues.findOne({name:nameVenue,organizationIdentifier:orgIdentifier},{_id:0,identifier:1,name:1,organizationIdentifier:1}).exec(function (err, data) {
			if(!data)
			{
