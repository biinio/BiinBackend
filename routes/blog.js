module.exports = function(){
  ...
  functions.entry = function(req, res){    
    res.render('blog/entry', { content: md('' + fs.readFileSync('./public/blog/' + req.params.year + "/" + req.params.month + "/" + req.params.day + "/" + req.params.title + ".markdown")), title: req.params.title });
  }
