...
module.exports = Vibrant = (function() {
  ...
  Vibrant.prototype.generateEmptySwatches = function() {
    ...
    //Added to avoid undefined Vibrant, finding color variation with lowered restrictions
    if (this.VibrantSwatch === void 0) {
      //Lower min saturation
        var satDecrement = 0.1;
        var lowerSat = this.opts.minVibrantSaturation - satDecrement;

        // Decrease saturation until a "suitable" vibrant color is selected
        while (lowerSat > 0) {
            this.VibrantSwatch = this.findColorVariation(this.opts.targetNormalLuma, this.opts.minNormalLuma, this.opts.maxNormalLuma, this.opts.targetVibrantSaturation, lowerSat, 1);  

            if (this.VibrantSwatch === void 0) {
                lowerSat = lowerSat - satDecrement;
            }
            else {
                lowerSat = 0;
            }
    ...
    if (this.DarkVibrantSwatch === void 0) {
      if (this.VibrantSwatch !== void 0) {
        ...
        this.DarkVibrantSwatch = new Swatch(util.hslToRgb(hsl[0], hsl[1], hsl[2]), 0);
      }
    }

    //Added to avoid undefined LightVibrantSwatch, using Vibrant
    if (this.LightVibrantSwatch === void 0) {
      if (this.VibrantSwatch !== void 0) {
        hsl = this.VibrantSwatch.getHsl();
        hsl[2] = this.opts.targetLightLuma + 0.1;
        this.LightVibrantSwatch = new Swatch(util.hslToRgb(hsl[0], hsl[1], hsl[2]), 0);
      }
    }
  };
